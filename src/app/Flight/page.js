...
export default function Flight() {
  ...
  return (
    <motion.div 
      className="bg-[#e8e7e5] min-h-screen pb-16"
      initial="hidden"
    ...
    >
      ...
      >
        <motion.h1 
          className="text-4xl sm:text-5xl lg:text-6xl font-bold text-black text-center mb-8"
          variants={itemVariants}
        >
          Our Flights
        </motion.h1>
        ...
        {/* Background Image */}
        <motion.div 
          className="relative w-full h-64 sm:h-80 lg:h-96 rounded-2xl overflow-hidden shadow-2xl mx-auto max-w-6xl"
          variants={itemVariants}
          whileHover={{ scale: 1.02 }}
          transition={{ duration: 0.3 }}
        >
          <Image
            src="/HomeImages/Background1.jpg"
            alt="Hot air balloon background"
            fill
      ...
      >
        <motion.h2 
          className="text-3xl text-[#C73309] sm:text-4xl lg:text-5xl font-bold text-center mb-6"
          variants={itemVariants}
        >
        ...
        <motion.p 
          className="text-lg sm:text-xl lg:text-2xl text-gray-700 text-center max-w-4xl mx-auto leading-relaxed"
          variants={itemVariants}
        >
          Each hot-air balloon ride is a unique experience, offering you stunning views of Marrakech, the Atlas Mountains, and the lush palm groves that surround the city.
        </motion.p>
      </motion.div>
